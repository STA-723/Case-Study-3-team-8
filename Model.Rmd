...
m0 %>%
  ...
  generate_table(name = "m0.tex", cap = "Variable importance for predictive model with restricted set of predictors")
```
...
m1 %>%
  ...
  generate_table(name = "m1.tex", cap = "Variable importance for predictive model with extensive set of predictors")
```
